...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var Collection<int, RoleCustomer>
     */
    #[ORM\ManyToMany(targetEntity: RoleCustomer::class, mappedBy: 'users')]
    private Collection $roleCustomers;
    ...
    {
        $this->roleCustomers = new ArrayCollection();
    ...
    /**
     * @return Collection<int, RoleCustomer>
     */
    public function getRoleCustomers(): Collection
    {
        return $this->roleCustomers;
    }

    public function addRoleCustomer(RoleCustomer $roleCustomer): static
    {
        if (!$this->roleCustomers->contains($roleCustomer)) {
            $this->roleCustomers->add($roleCustomer);
            $roleCustomer->addUser($this);
        }

        return $this;
    }

    public function removeRoleCustomer(RoleCustomer $roleCustomer): static
    {
        if ($this->roleCustomers->removeElement($roleCustomer)) {
            $roleCustomer->removeUser($this);
        }
